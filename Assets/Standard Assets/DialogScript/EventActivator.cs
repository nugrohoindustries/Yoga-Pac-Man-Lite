...
//	public GameObject tombol2;
	...
	void Start(){
	//	if(!audios){
	//			audios = GameObject.FindWithTag("Audiosource");
	//		}
	//	if(!tombol){
	//			tombol = GameObject.FindWithTag("Tombol");
	//		}
	//	if(!tombol2){
	//			tombol2 = GameObject.FindWithTag("Tombol2");
	//		}
	//	if(!moving){
	//			moving = GameObject.FindWithTag("Moving");
	//	} 
	...
	//	}
	//	if (tombol2 != null){
	//		tombol2.gameObject.SetActive(true);
	//	}
		if (moving != null){
	...
	//	}
	//	if (tombol2 != null){
	//		tombol2.gameObject.SetActive(false);
	//	}
		if (moving != null){
